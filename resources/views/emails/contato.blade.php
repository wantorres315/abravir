...
<div align="center" class="alignment" style="line-height:10px"><img alt="logo" class="big" src="{{ asset('images/logo.png')}}" style="display: block; height: auto; border: 0; width: 420px; max-width: 100%;" title="I'm an image" width="420"/></div>
</td>
</tr>
</table>
...
<p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 24px;"><strong><span style="font-size:38px;">Novo Contato do site ABRAVIR</span></strong></p>
</div>
</div>
</td>
</tr>
...
<p style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 40px;"><span style="font-size:20px;"><strong><span style="">Dados:</span></strong></span></p>
</div>
</div>
</td>
</tr>
...
<p style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 28px;">Nome: {{$nome}} </p>
<p style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 28px;">E-mail: {{$email}}  </p>
<p style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 28px;">Telefone: {{$telefone}} </p>
<p style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 28px;">Mensagem: {{$mensagem}} </p>
</div>
</div>
</td>
</tr>
