                      ...
                      <div class="range range-sm-bottom range-15 row">
                        ...
                        <div class = "row">
                          <div class="cell-sm-6 col-lg-6">
                            <a href = "/cancela_associacao/{{$cliente->id}}" class="btn btn-sm btn-danger btn-block btn-circle form_enviar" >Pensei bem e não quero me associar</a>
                            
                          </div>
                          <div class="cell-sm-6 col-lg-6">
                            <a href = "/confirma_associacao/{{$cliente->id}}" class="btn btn-sm btn-primary btn-block btn-circle form_enviar" >Quero me associar</a>
                          </div>
                        </div>  
                    </div>
            </section>
